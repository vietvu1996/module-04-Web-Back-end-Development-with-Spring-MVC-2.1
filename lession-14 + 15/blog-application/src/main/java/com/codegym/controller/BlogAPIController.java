...
public class BlogAPIController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Iterable<Blog>> searchBlog(@RequestParam("content") String content) {
        Iterable<Blog> blogs = blogService.findAllContainingContentOrContainingName(content, content);
        if (blogs == null) {
    ...
    @GetMapping("/load")
    public ResponseEntity<Iterable<Blog>> loadBlog() {
